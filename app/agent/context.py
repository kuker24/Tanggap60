...
_QUICK_BY_STATE: dict[str, list[str]] = {
    ...
    "WAITING_APPROVAL": ["Apa yang akan dikirim?", "Buka situs resmi"],
    "GENERATING": ["Apa yang akan dikirim?", "Buka situs resmi"],
    "VERIFYING": ["Apa yang akan dikirim?", "Buka situs resmi"],
    "HANDOFF_READY": ["Apa yang akan dikirim?", "Buka situs resmi"],
